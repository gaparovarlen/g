...
SMS_AUTH_SETTINGS.setdefault("SMS_USER_FIELD", "user_name")
SMS_AUTH_SETTINGS.setdefault("SMS_DEBUG", False)
SMS_AUTH_SETTINGS.setdefault("SMS_DEBUG_CODE", 1111)
SMS_AUTH_SETTINGS.setdefault("SMS_AUTH_CODE_LEN", 6)
...
SMS_AUTH_SETTINGS.setdefault("SMS_USER_SERIALIZER", "sms_auth.serializers.DefaultUserSerializer")
